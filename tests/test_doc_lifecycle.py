...
REFRESHED_CURRENT_GUIDANCE_DOCS = {
    ...
    Path("docs/architecture/north-stars/llm-worker-orchestration.md"),
...
def test_llm_worker_orchestration_refresh_queue_item_is_closed():
    queue = DOC_REFRESH_QUEUE.read_text(encoding="utf-8")

    assert "`docs/architecture/north-stars/llm-worker-orchestration.md`" not in queue
