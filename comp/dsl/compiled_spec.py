...
from comp.dsl.ast_nodes import BindStmt, ParserInheritStmt, TagStmt
from comp.dsl.lex_ir import LexExpr
from comp.dsl.rule_ir import RuleExpr
from comp.dsl.source_ir import SourceExpr
from comp.dsl.spec_nodes import (
    ConstraintSpec,
    DiagnosticSpec,
    GovernancePolicy,
    InferSpec,
